function looksLikeUtf8DecodedAsLatin1(value: string): boolean {
    ...
    // NBSP UTF-8 C2 A0 -> "Â ", ® UTF-8 C2 AE -> "Â®" e
    // narrow no-break space UTF-8 E2 80 AF -> "â¯".
    // Não casa com um Â legítimo em palavras como "LÂMINA".
    return /(?:Ã[\u0080-\u00bf]|Â[\u0080-\u00bf\u00a0-\u00ff]|â[\u0080-\u00bf])/.test(value);
}
 ...
 * NBSP e narrow NBSP são normalizados para espaço comum para evitar nomes
 * visualmente iguais, porém byte-a-byte diferentes.
 */
