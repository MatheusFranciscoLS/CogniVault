...
test('infere STARTER a partir das próprias linhas vendáveis', () => {
...
test('infere CRANKCASE & CLUTCHDRUM sem confundir a embreagem interna com a vista CLUTCH', () => {
  assert.equal(inferCatalogSection([
    { name: 'CRANKCASE KIT' },
    { name: 'ROLAMENTO DE ESFERAS 6001 C3' },
    { name: 'VOLANTE Flywheel' },
    { name: 'BOBINA DE IGNIÇÃO Coil Assy' },
    { name: 'CONJ DE EMBRAIAGEM' },
  ]), 'CRANKCASE & CLUTCHDRUM');
});

test('infere CLUTCH quando tambor e componentes da embreagem dominam a tabela', () => {
  assert.equal(inferCatalogSection([
