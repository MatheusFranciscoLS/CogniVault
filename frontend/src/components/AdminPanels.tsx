...
export function UsersPanel(){
  ...
  return <section>
    <p className="cv-kicker">Controle de acesso</p><h1 className="cv-page-title">Usuários</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">A empresa trabalha com dois perfis simples: Administrador e Balcão. Crie acessos, bloqueie contas e redefina senhas por aqui.</p>
