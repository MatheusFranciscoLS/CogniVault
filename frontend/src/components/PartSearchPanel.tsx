                              ...
                              <div className="mt-1 flex flex-wrap items-baseline gap-2">
                                ...
                                <div className="ml-1 flex items-center gap-1">
                                  <button
                                    ...
                                    className="inline-flex items-center rounded-md p-1 text-slate-400 hover:text-[#1d4f91] dark:hover:text-blue-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition"
                                  >
                                    📋
                                  </button>
                                  <button
                                    ...
                                    onClick={(e) => {
                                      e.stopPropagation();
                                      void copyCode(cleanErpCode(formattedCode));
                                    }}
                                    title="Copiar para ERP (sem formatação)"
                                    className="inline-flex items-center justify-center rounded-md px-1.5 py-0.5 text-[10px] font-bold text-slate-400 hover:text-white dark:hover:text-white hover:bg-[#1d4f91] dark:hover:bg-blue-600 transition"
                                  >
                                    ERP
                                  </button>
                                </div>
                ...
                <div className="rounded-[22px] bg-gradient-to-br from-[#0a1b38] to-[#122e5a] p-6 text-white shadow-xl relative overflow-hidden">
                  ...
                  <div className="mt-5 flex flex-wrap items-center gap-2.5">
                    ...
                    <button
                      ...
                      className="rounded-xl border border-white/20 bg-white/10 hover:bg-white/20 px-3.5 py-2.5 text-xs font-semibold text-white transition active:scale-95 flex items-center gap-2"
                    >
                      <span>📋</span> Copiar ({detailFormattedCode})
                    </button>
                    <button
                      type="button"
                      onClick={() => void copyCode(cleanErpCode(detailFormattedCode))}
                      className="rounded-xl border border-[#1d4f91]/40 bg-[#1d4f91]/30 hover:bg-[#1d4f91]/60 px-3.5 py-2.5 text-xs font-bold text-white transition active:scale-95 flex items-center gap-1.5"
                    >
                      ERP ({cleanErpCode(detailFormattedCode)})
                    </button>
