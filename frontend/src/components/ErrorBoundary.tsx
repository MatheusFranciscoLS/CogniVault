...
export class ErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-slate-50 p-6 text-slate-800 dark:bg-slate-900 dark:text-slate-200">
          <div className="cv-surface max-w-md rounded-2xl p-8 text-center shadow-xl">
            ...
            <div className="mt-4 overflow-auto rounded-xl bg-slate-100 p-4 text-left text-xs text-slate-700 dark:bg-slate-800 dark:text-slate-300">
