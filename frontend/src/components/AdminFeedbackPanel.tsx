...
export default function AdminFeedbackPanel(){
  ...
  return <section>
    ...
    <div className="mt-4 rounded-[18px] border border-slate-200 bg-white/80 px-4 py-3 text-xs leading-5 text-slate-600">Um voto isolado tem peso pequeno. Repetições do mesmo usuário não são contadas como novo consenso técnico; confirmações independentes e correções explícitas recebem mais peso, sempre com um limite seguro. {topReason?`Motivo de erro mais frequente: ${reasonLabel[topReason[0]]||topReason[0]} (${topReason[1]}).`:''}</div>
